...
void Gadget4Reader_t::LoadSnapshotAndHalo(MpiWorker_t &world, int snapshotId, vector <Particle_t> &Particles, Cosmology_t &Cosmology, vector <Halo_t> &Halos)
{
  LoadSnapshot(world, snapshotId, Particles, Cosmology);
...
void Gadget4Reader_t::LoadGroups(MpiWorker_t &world, int snapshotId, vector< Halo_t >& Halos)
...
void Gadget4Reader_t::ExchangeAndMerge(MpiWorker_t& world, vector< Halo_t >& Halos)
{
